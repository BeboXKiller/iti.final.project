...
@section('content')
    ...
    <div id="settings" class="page">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-md text-center">
            ...
            <h3 class="text-xl font-heading font-bold mb-2">Settings Coming Soon</h3>
            <p class="text-gray-600 mb-6">We're working on comprehensive settings for your admin dashboard.</p>
