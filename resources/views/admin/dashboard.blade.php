    ...
    <div class="flex-1 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="dashboard-card bg-white rounded-2xl p-6 shadow-md transition-all duration-300">
                ...
                <div class="text-3xl font-bold text-gray-800">1,246</div>
            ...
            <div class="dashboard-card bg-white rounded-2xl p-6 shadow-md transition-all duration-300">
                ...
                <div class="text-3xl font-bold text-gray-800">5,321</div>
            ...
            <div class="dashboard-card bg-white rounded-2xl p-6 shadow-md transition-all duration-300">
                ...
                <div class="text-3xl font-bold text-gray-800">286</div>
