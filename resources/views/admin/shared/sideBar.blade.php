...
<div class="sidebar bg-white w-64 min-h-screen shadow-md py-4 hidden md:block" id="sidebar">
    <nav class="mt-4">
        ...
        <a href="{{ '/stylemart/admin/customers' }}" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:bg-light">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" class="mr-3">
                <path fill="currentColor"
        ...
        <a href="{{ '/stylemart/admin/categories' }}" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:bg-light">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" class="mr-3">
                <path fill="currentColor"
        ...
        <a href="{{ '/stylemart/admin/analytics' }}" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:bg-light">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" class="mr-3">
                <path fill="currentColor"
        ...
        <a href="{{ '/stylemart/admin/reports' }}" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:bg-light">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" class="mr-3">
                <path fill="currentColor"
        ...
        <a href="{{ '/stylemart/admin/settings' }}" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:bg-light">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" class="mr-3">
                <path fill="currentColor"
