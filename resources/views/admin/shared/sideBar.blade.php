...
<div class="sidebar bg-white w-64 min-h-screen shadow-md py-4" id="sidebar">
    <nav class="mt-4">
        ...
        {{-- <a href="{{ route('admin.dashboard') }}"
            ...
            <a href="{{route('admin.dashboard')}}"
                class="nav-item flex items-center px-4 py-3 text-gray-700 hover:bg-light" data-page="dashboard">
            ...
            <div class="dropdown-container">
                ...
                <div class="nav-item dropdown-btn flex items-center px-4 py-3 text-gray-700 hover:bg-light"
                ...
                <div class="dropdown-content" data-dropdown-content="products">
                    ...
                    <a href="{{ route('products.index') }}" class="dropdown-item flex items-center"
                    ...
                    <a href="{{ route('products.create') }}" class="dropdown-item flex items-center"
            ...
            <a href="{{ route('admin.dashboard.orders') }}"
                class="nav-item flex items-center px-4 py-3 text-gray-700 hover:bg-light" data-page="orders">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" class="mr-3">
                    <path fill="currentColor"
            ...
            <div class="dropdown-container">
                ...
                <div class="dropdown-content" data-dropdown-content="categories">
                    <a href="{{ route('categories.index') }}" class="dropdown-item flex items-center"
                    ...
                    <a href="{{ route('categories.create') }}" class="dropdown-item flex items-center"
