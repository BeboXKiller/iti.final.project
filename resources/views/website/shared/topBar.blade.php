    ...
    <div class="container mx-auto px-4 py-3">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-5">
                ...
                <!-- Cart / Shopping Bag -->
                <a href="{{ route('cart.index') }}" class="text-gray-800 hover:text-primary relative" title="Cart">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <span
                        class="absolute -top-0.5 -right-1 bg-red-600 text-white text-xs rounded-full w-4 h-4 flex items-center justify-center">
                        {{ Cart::count() }}
                    </span>
                </a>
