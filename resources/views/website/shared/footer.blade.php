            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                <div>
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="bg-white bg-opacity-20 p-2 rounded-full hover:bg-secondary">
                ...
                <div>
                    <h3 class="text-xl font-heading font-bold mb-4">Shopping</h3>
                    <ul class="space-y-2">
                        <li><a href="#" class="hover:text-accent">Women Fashion</a></li>
                        <li><a href="#" class="hover:text-accent">Men Fashion</a></li>
                        <li><a href="#" class="hover:text-accent">Kids Fashion</a></li>
                        <li><a href="#" class="hover:text-accent">Accessories</a></li>
                        <li><a href="#" class="hover:text-accent">Sale</a></li>
                    </ul>
                </div>

                <div>
                    <h3 class="text-xl font-heading font-bold mb-4">Help</h3>
                    <ul class="space-y-2">
                        <li><a href="#" class="hover:text-accent">FAQ</a></li>
                        <li><a href="#" class="hover:text-accent">Shipping</a></li>
                        <li><a href="#" class="hover:text-accent">Returns</a></li>
                        <li><a href="#" class="hover:text-accent">Order Status</a></li>
                        <li><a href="#" class="hover:text-accent">Privacy Policy</a></li>
                    </ul>
                </div>

                <div>
                    <h3 class="text-xl font-heading font-bold mb-4">Newsletter</h3>
                    <p class="mb-4">Subscribe to get special offers, free giveaways, and new arrivals.</p>
                    <form class="flex">
                        <input type="email" placeholder="Your email"
                            class="px-4 py-2 w-full rounded-l-lg focus:outline-none text-dark">
                        <button type="submit"
                            class="bg-secondary text-white px-4 py-2 rounded-r-lg hover:bg-accent">Subscribe</button>
                    </form>
                </div>
            </div>

            <div class="border-t border-white border-opacity-20 pt-6 mt-6 text-center">
