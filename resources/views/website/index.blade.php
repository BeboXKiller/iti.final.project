        ...
        <div class="p-6">
            <form class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Password</label>
                    <input type="password" class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
                </div>
                <div>
            ...
            <div class="swiper-slide">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-10">
                    <div class="text-white px-6">
                        ...
                        <p class="mb-6">A specialist label creating luxury essentials. Ethically crafted with an unwavering commitment to exceptional quality.</p>
                        <a href="#" class="bg-secondary text-white px-6 py-3 rounded-full font-medium inline-flex items-center">
                            Shop Now
                        </a>
                    </div>
            ...
            <div class="swiper-slide">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-10">
                    <div class="text-white px-6">
                        ...
                        <p class="mb-6">Discover the latest trends in fashion and upgrade your wardrobe with our new collection.</p>
                        <a href="#" class="bg-secondary text-white px-6 py-3 rounded-full font-medium inline-flex items-center">
                            Shop Collection
                        </a>
                    </div>
                    <div class="flex justify-center">
                        <img src="https://placehold.co/500x600/EFE4D2/254D70?text=New+Arrivals"
                            alt="New Arrivals" class="rounded-2xl shadow-xl">
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-12 bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <a href="{{ route('category.products', ['category' => 1]) }}"
            ...
            <a href="{{ route('category.products', ['category' => 2]) }}"
                class="category-item group bg-light rounded-2xl p-6 text-center transition-all duration-300 shadow-md hover:shadow-xl">
                <div
                    class="bg-white rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4 group-hover:bg-accent transition-colors">
            ...
            <a href="{{ route('category.products', ['category' => 3]) }}"
                class="category-item group bg-light rounded-2xl p-6 text-center transition-all duration-300 shadow-md hover:shadow-xl">
                <div
                    class="bg-white rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4 group-hover:bg-accent transition-colors">
            ...
            <a href="{{ route('category.products', ['category' => 4]) }}"
                class="category-item group bg-light rounded-2xl p-6 text-center transition-all duration-300 shadow-md hover:shadow-xl">
                <div
                    class="bg-white rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4 group-hover:bg-accent transition-colors">
